              ...
              child: StylishBottomBar(
                ...
                items: [
                  ...
                  BottomBarItem(
                      ...
                      title:
                          const Text('Katalog', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w500)),
                      selectedColor: Colors.black87),
                  BottomBarItem(
                      icon: Stack(children: [
                  ...
                  BottomBarItem(
                      icon: SvgPicture.asset('assets/images/ic_like.svg',
                          height: 24, width: 24, color: AppColors.lightGrayColor),
                      title:
                          const Text('Sevimli', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w500)),
                      selectedColor: Colors.black87),
                ],
                hasNotch: true,
                currentIndex: tabProvider.currIndex,
